...
async function getData() {
    ...
    for (element of data) {
        ...
        for (var i in element.formNameTimeline) {
            ...
            dataNewFormat.push({
                ...
                lastUnlockOccurence: element.lastUnlockOccurence[element.formNameTimeline[i]],
                lastUnlockTrial: element.lastUnlockTrial[element.formNameTimeline[i]],
    ...
    const headers = {
        ...
        nbUnusefulClick: 'nb_useless_click',
